...
var BlogRepository = /** @class */ (function () {
    function BlogRepository(contentfulStorage) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.storage.getAll()];
                    case 1:
                        posts = _a.sent();
                        return [2 /*return*/, mapper_1.postMapper(posts.items)];
                    case 2:
                        error_1 = _a.sent();
    ...
    BlogRepository.prototype.getById = function () {
        return '';
    };
